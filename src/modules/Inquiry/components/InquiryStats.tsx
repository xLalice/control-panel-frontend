...
import { InquiryStatistics } from '../inquiry.types';
import { DELIVERY_METHOD_COLORS, INQUIRY_TYPE_COLORS, PRIORITY_COLORS, REFERENCE_SOURCE_COLORS, STATUS_CONFIG, STATUS_ORDER } from '../inquiry.constants';
...
function InquiryStats() {
  const { data, isLoading, isError, error } = useQuery<InquiryStatistics, Error>({
    ...
    queryFn: () => inquiryApi.getStatistics(),
  });

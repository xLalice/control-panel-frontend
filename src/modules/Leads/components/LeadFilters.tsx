...
import { Input, Select, SelectContent, SelectTrigger, SelectValue, SelectItem, Button} from "@/components/ui"
...
export const LeadFilters: React.FC<LeadFilterProps> = ({isFilterOpen, register, control, users, hasActiveFilters, resetFilters}) => {
    return (
        <div
                      id="filter-panel"
